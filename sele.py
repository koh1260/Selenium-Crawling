...
driver = webdriver.Chrome("/Users/ganghaeseong/Documents/croll/chromedriver")#chromedriver를 사용하기위한 webdriver함수 사용
...
while True: #break가 일어날 때 까지 계속 반복
    ...
    if new_height == last_height:#이전 스크롤 길이와 현재의 스크롤 길이를 비교2
        try:
